...
(function(){
    ...
    BE.bd.Items._init=function()"use strict";
var BE={}; // the Brave Eats
(function(){
    console.log("be loading");
    ...
    BE.bd.Items._cItem=function() // class Item
    {
        ...
        this.type="SYS";
        this.getData=function(dataIn,tagIn){return undefined;};
        this.setData=function(dataIn,tagIn,valueIn){return dataIn;};
        this.compareDataTag=function(dataIn,tagIn,valueIn{return dataIn[tagIn]==valueIn;};
        this.getDefaultData=function(){return {};};
